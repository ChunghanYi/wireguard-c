...
/**** In fact, the information below is not used. Instead, use the /etc/wireguard.conf file. ****/

#define WG_LOCAL_ADDRESS        IPADDR4_INIT_BYTES(10, 1, 1, 100)  //my vpn ip address
...
#define WG_ENDPOINT_ADDRESS     IPADDR4_INIT_BYTES(192, 168, 8, 139)  //peer real(endpoint) ip address
